...
if (isset($_POST['insertausuario'])) {
  ...
  $query = "INSERT INTO usuario(Contraseña, Identificacion,PrimerApellido,PrimerNombre,TipoUsuario,Usuario) VALUES ('$Contraseña', '$Identificacion', '$PrimerApellido','$PrimerNombre','$TipoUsuario','$Usuario')";
